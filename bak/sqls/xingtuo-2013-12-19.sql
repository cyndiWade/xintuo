...
CREATE TABLE IF NOT EXISTS `xt_product_user` (
  ...
  `users_id` int(10) unsigned NOT NULL COMMENT '用户ID',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='产品用户关系表' AUTO_INCREMENT=8 ;
...
(1, 'admin', '管理', 'e10adc3949ba59abbe56e057f20f883e', 1387434219, '192.168.1.100', 185, 1376561926, 1376561926, 0, 0),
(2, '13761951734', 'wade', 'e10adc3949ba59abbe56e057f20f883e', 1387432048, '192.168.1.100', 19, 1377506459, 1377506459, 1, 0),
...
(7, '13761951738', '', 'e10adc3949ba59abbe56e057f20f883e', 1384154533, '117.136.8.21', 3, 1377852591, 1377852591, 2, 0),
...
(2, 2, 21, 4, 21, '男', '', 'lin@qq.com', '上海', '上海市', '陆家嘴', '期货产品', '无', '<u><b>dadasa<strike>sdasdas</strike></b></u>'),
(3, 3, 0, 0, 22, '女', NULL, 'wuzhiyong', '上海', '上海市', '陆家嘴', '暂无', '无', NULL),
(5, 5, 10, 0, 7, '男', NULL, 'aaaaa@qq.com', 'bbbb', 'ccc', 'ddde', 'eee', 'fff', 'ggggggggg~'),
(6, 100, 0, 0, 6, '女', NULL, '', '', '', '', '', '', ''),
(10, 6, 7, 0, 6, '女', NULL, '12313123@qq.com', '12312312bb', '22222222', '', '', '', ''),
...
(23, 22, 26, 0, 1, '男', '320248199101050106', '', '上海', '上海', '黄浦区大沽路100号', '信托', '中铁信托', '<P>产品名称：中铁信托</P>\r\n<P>产品期限：12个月</P>'),
(24, 23, 25, 0, 1, '男', '', '', '', '', '', '', '', 'test'),
