...
(1, 'admin', '管理员', 'e10adc3949ba59abbe56e057f20f883e', 1377769739, '127.0.0.1', 99, 1376561926, 1376561926, 0, 0),
...
CREATE TABLE IF NOT EXISTS `xt_user_info` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_id` (`user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8 COMMENT='用户详细资料' AUTO_INCREMENT=4 ;

--
-- 转存表中的数据 `xt_user_info`
--

INSERT INTO `xt_user_info` (`id`, `user_id`, `file_id`, `age`, `sex`, `email`, `province`, `city`, `street`, `interest`, `remarks`) VALUES
(1, 1, 3, 20, '男', 'ucdchina@gmail.com', '广东省', '深圳市', '111号', '理财产品', NULL),
(2, 2, 4, 21, '男', 'lin@qq.com', '上海', '上海市', '陆家嘴', '期货产品', NULL),
(3, 3, 0, 22, '女', 'wuzhiyong', '上海', '上海市', '陆家嘴', '暂无', NULL);
