			...
			<div id="primary_right">
				<div class="inner">
					...
					<div class="notification secure"> 
						<span></span> 
						<div class="text"> 
							<p><strong>已被管理客户区域</strong></p> 
						</div>        
					</div> 	
					<div id="Director">
						<?php if(is_array($list_one)): $i = 0; $__LIST__ = $list_one;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="users" data-user_id="<?php echo ($vo["id"]); ?>">
							<div class="portlet">
								<div class="portlet-header"><?php echo ($vo["account"]); ?></div>
								<div class="portlet-content" style="display: block;">
									...
									<p><?php echo ($vo["sex"]); ?> <?php echo ($vo["age"]); ?></p>
								</div>
							</div>
					...
					<div class="notification tip"> 
						<span></span> 
						 <div class="text"> 
							<p><strong>待分配客户区域</strong></p> 
						</div> 
					</div> 		
					<div id="User">		
						<?php if(is_array($list_two)): $i = 0; $__LIST__ = $list_two;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><div class="users" data-user_id="<?php echo ($vo["id"]); ?>">
							<div class="portlet">
								<div class="portlet-header"><?php echo ($vo["account"]); ?></div>
								<div class="portlet-content" style="display: block;">
									<?php if(($vo["file_address"] != NULL)): ?><img src="<?php echo ($vo["file_address"]); ?>" alt="" style="width:60px;height:60px;"/>
...
<input type="hidden" id="director_id" value="<?php echo ($id); ?>" />
</body>
</html>