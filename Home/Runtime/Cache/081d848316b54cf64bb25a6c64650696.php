			...
			<div id="primary_right">
				...
				<form action="" method="post">
					...
					<fieldset>
						...
						<p>
							<label>新闻名称：</label>
							<input class="sf" type="text" name="name" value="<?php echo ($news_info["name"]); ?>" />
							<span class="validate_success">*必填</span>
						</p>


						<p><label>新闻内容：</label></p>
						<textarea class="cleditorMain" name="content"><?php echo ($news_info["content"]); ?></textarea>
