			...
			<div id="primary_right">
				<div class="inner">
					...
					<table class="normal tablesorter fullwidth">
						...
						<tbody>
							<?php if(is_array($html_list)): $i = 0; $__LIST__ = $html_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(($i % 2 == 0) ): $odd = 'class=odd'; ?>
								<?php else: ?>
									<?php $odd = ''; endif; ?>
							
							<tr <?php echo ($odd); ?>>
								<td><?php echo ($i); ?></td>
								<td><img src="<?php echo ($vo["file_address"]); ?>" alt="" style="width:60px;height:60px;"/></td>
								<td><?php echo ($vo["name"]); ?></td>
								<td><?php echo ($vo["time"]); ?></td>
								<td>
								<!-- <a href="?s=/Advertisement/edit/act/edit/id/<?php echo ($vo["id"]); ?>" title="编辑" class="tooltip table_icon"><img src="<?php echo (APP_PATH); ?>Public/assets/icons/actions_small/Pencil.png" alt="" /></a> -->	
									<a href="?s=/Advertisement/edit/act/delete/id/<?php echo ($vo["aid"]); ?>" title="删除" class="tooltip table_icon delete"><img src="<?php echo (APP_PATH); ?>Public/assets/icons/actions_small/Trash.png" alt="" /></a>			
								</td>
