		...
		<div id="bgwrap">
			...
			<div id="primary_right">
				<div class="inner">
					...
					<form action="?s=/User/user_list" method="POST" name="aaa">
					<fieldset>
						<legend>查询用户</legend>
						
						<p>
							账号：
							<input  type="text"  name="account" value="" class="small"/>
							姓名：
							<input  type="text"  name="name" value="" class="small"/>
							身份证：
							<input  type="text"  name="identity" value="" class="small"/>
					...
					<p ><label><?php echo ($header); ?></label></p>
					...
					<table class="normal tablesorter fullwidth">
						...
						<tbody>
							...
							<tr <?php echo ($odd); ?>>
								<td><?php echo ($i); ?></td>
								<td>
									<?php if(($vo["file_address"] != NULL)): ?><img src="<?php echo ($vo["file_address"]); ?>" alt="" style="width:60px;height:60px;"/>
									<?php else: ?>
										<img src="<?php echo (APP_PATH); ?>Public/assets/avatar.png" alt="" /><?php endif; ?>	
								</td>
								...
								-->
								<td>
									<a href="?s=/User/user_edit/id/<?php echo ($vo["id"]); ?>" title="编辑查看" class="tooltip table_icon"><img src="<?php echo (APP_PATH); ?>Public/assets/icons/actions_small/Pencil.png" alt="" /></a> 
									<a href="?s=/User/user_del/id/<?php echo ($vo["id"]); ?>" title="删除账号" class="tooltip table_icon delete"><img src="<?php echo (APP_PATH); ?>Public/assets/icons/actions_small/Trash.png" alt="" /></a>

									<?php if(($vo["type"] == '客户经理')): ?><!-- 
										<a href="?s=/Director/relation/id/<?php echo ($vo["id"]); ?>" title="管理客户"  class="tooltip table_icon"><img alt="" src="<?php echo (APP_PATH); ?>Public/assets/icons/actions_small/Preferences.png"></a>
										-->
										<a href="?s=/DirectorUser/director_user/id/<?php echo ($vo["id"]); ?>" title="管理客户"  class="tooltip table_icon"><img alt="" src="<?php echo (APP_PATH); ?>Public/assets/icons/actions_small/Preferences.png"></a><?php endif; ?>			
								</td>
