			...
			<div id="primary_right">
				...
				<form action="" method="post" enctype="multipart/form-data">
					...
					<fieldset>
						...
						<p>
							<label>理财产品:</label>
							<select name="product_id" class="dropdown">	
								<option value="" >请选择一个理财产品</option>
								<?php if(is_array($prodect_list)): $i = 0; $__LIST__ = $prodect_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo["id"]); ?>"><?php echo ($vo["name"]); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
							</select>
							<span class="validate_success">*必选</span>
						</p>
						
						<p>
							<label>上传图片:</label>
							<input class="sf" type="file" name="img_file" />
							<span class="validate_success">*必选(1136x640  或 960x640 的图片)</span>
						</p>
						
						
						<p><input class="button" type="submit" value="确认" /></p>
					</fieldset>
				</form>
