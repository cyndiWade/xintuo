		...
		<div id="bgwrap">
			...
			<div id="primary_right">
				<div class="inner">
					...
					<form action="?s=/Message/index/" method="POST" name="aaa">
					<fieldset>
						<legend>搜索</legend>
						<p>
							<input type="radio"  name="is_reply" value="1" >
							待回复
							<input type="radio" name="is_reply" value="0" >
							已回复 
						</p>
					...
					<table class="normal tablesorter fullwidth">
						...
						<tbody>
							...
							<tr <?php echo ($odd); ?>>
								...
								<td><?php echo ($vo["is_reply"]); ?></td>			
								<td>
									<a href="?s=/Message/receive_question/qid/<?php echo ($vo["id"]); ?>/user_id/<?php echo ($vo["user_id"]); ?>" title="编辑回复" class="tooltip table_icon"><img src="<?php echo (APP_PATH); ?>Public/assets/icons/actions_small/Pencil.png" alt="" /></a> 
									<a href="?s=/Message/question_del/qid/<?php echo ($vo["id"]); ?>" title="删除" class="tooltip table_icon delete"><img src="<?php echo (APP_PATH); ?>Public/assets/icons/actions_small/Trash.png" alt="" /></a>
								</td>
