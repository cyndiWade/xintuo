			...
			<div id="primary_right">
				...
				<form action="" method="post">
					...
					<fieldset>
						...
						<p>
							<label>产品名称：</label>
							<input class="sf" type="text" name="name" value="<?php echo ($product_info["name"]); ?>" />
							<span class="validate_success">*必填</span>
						</p>


						<p><label>理财产品内容：</label></p>
						<textarea class="cleditorMain" name="content"><?php echo ($product_info["content"]); ?></textarea>
