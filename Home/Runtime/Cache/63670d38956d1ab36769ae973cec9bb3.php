		...
		<div id="bgwrap">
			...
			<div id="primary_right">
				<div class="inner">
					...
					<ul class="dash all_menu">
						
						<li class="fade_hover tooltip" title="系统" data-menu_name="系统">
							<a href="?s=/System/index">
								<img src="<?php echo (APP_PATH); ?>Public/assets/icons/dashboard/21.png" alt="" />
								<span>系统</span>
							</a>
						</li>
				
						<li class="fade_hover tooltip" title="共<?php echo ($num); ?>个用户" data-menu_name="用户管理">
							<span class="bubble"><?php echo ($num); ?></span>
							<a href="?s=/User/user_list">
								<img src="<?php echo (APP_PATH); ?>Public/assets/icons/dashboard/54.png" alt="" />
								<span>用户管理</span>
							</a>
						</li>
						
						<!--
						<li class="fade_hover tooltip" title="推送消息" data-menu_name="推送消息">
							<a href="?s=/Send/index">
								<img src="<?php echo (APP_PATH); ?>Public/assets/icons/dashboard/42.png" alt="" />
								<span>推送系统消息</span>
							</a>
						</li>
						 -->
						 
						 <li class="fade_hover tooltip" title="<?php echo ($question_num); ?> 条待回复提问!" data-menu_name="用户提问">
							<span class="bubble"><?php echo ($question_num); ?></span>
							<a href="?s=/Message/index/">
								<img src="<?php echo (APP_PATH); ?>Public/assets/icons/dashboard/75.png" alt="" />
								<span>待回复</span>
							</a>
						</li>
						
						<li class="fade_hover tooltip" title="退出系统">
							<a href="?s=/Login/logout" >
								<img src="<?php echo (APP_PATH); ?>Public/assets/icons/dashboard/118.png" alt="" />
								<span>退出系统</span>
							</a>
						</li>
